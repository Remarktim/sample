   ...
   <link
      ...
      <style>
         body {
            ...
            #password, #email, #cpassword, #fname, #lname, #number, #email{
               border: 0;
            }
      ...
      <div class="form-control" id="form">
        ...
        <div class="mb-3">
          ...
          <div class="input-group mb-3">
            ...
            class="form-control form-control-lg"
            aria-describedby="button-addon2" />
            <button class="bi bi-eye-slash btn btn-outline-secondary form-control-lg" id="button-addon3" itemid="toggleCPassword" type="button"></button>
          </div>
